...
class AppDBUtil():
    ...
    def searchTransactions(cls, search_query):
        ...
        for transaction in transaction_details:
            ...
            client['recurring_payment_start_date'] = transaction.recurring_payment_start_date.strftime("%m/%d/%Y") if transaction.recurring_payment_start_date else ''
            client['pause_payment'] = transaction.pause_payment
            client['paused_payment_resumption_date'] = transaction.paused_payment_resumption_date.strftime("%m/%d/%Y") if transaction.paused_payment_resumption_date else ''
