...
class Prospect(db.Model):
    #id = db.Column(db.Integer, primary_key=True)
    prospect_id = db.Column(db.String(8), primary_key=True, index=True, nullable=False, default='')
    first_name = db.Column(db.String(64), index=True,nullable=False, default='')
    last_name = db.Column(db.String(64), index=True,nullable=False, default='')
    email = db.Column(db.String(64), index=True, nullable=False, default='')
    phone_number = db.Column(db.String(64), index=True, nullable=False, default='')
...
class Student(db.Model):
    prospect_id = db.Column(db.String(8), db.ForeignKey('prospect.prospect_id'), index=True, nullable=False, default='')
    student_id = db.Column(db.String(8), primary_key=True, index=True, nullable=False, default='')
    ...
    student_email = db.Column(db.String(64), index=True, nullable=False, default='')
    student_phone_number = db.Column(db.String(64), index=True, nullable=False, default='')
    ...
    parent_1_phone_number = db.Column(db.String(64), index=True, nullable=False, default='')
    ...
    parent_2_phone_number = db.Column(db.String(64), index=True, nullable=False, default='')

    def __repr__(self):
        return '<Client {} created with client_id {}>'.format(self.parent_1_last_name, self.student_id)
