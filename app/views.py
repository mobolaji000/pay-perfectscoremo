...
def start_background_jobs_before_first_request():
    ...
    if os.environ['DEPLOY_REGION'] == 'local':
        ...
        scheduler.add_job(setup_recurring_payments_due_today_background_job, 'interval', minutes=113)
        scheduler.add_job(pay_invoice_background_job,'interval', minutes=115)
